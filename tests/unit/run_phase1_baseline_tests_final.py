...
def run_all_baseline_tests():
    ...
    # Skip GPU tests due to memory constraints for this model
    print("\n" + "="*50)
    print("SKIPPING GPU BASELINE TESTS DUE TO MEMORY CONSTRAINTS")
    print("="*50)
    print("Model is too large for GPU memory (2GB available, ~3.4GB required)")
