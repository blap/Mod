...
from src.inference_pio.common.feedback_integration import FeedbackIntegrationMixin


class MockModel(RealGLM47Model, FeedbackIntegrationMixin):
    """Real model for testing feedback integration."""

    def __init__(self):
        # Initialize with smaller parameters for testing
        RealGLM47Model.__init__(self,
            hidden_size=64,
        ...
        FeedbackIntegrationMixin.__init__(self, model_id="test_model")
