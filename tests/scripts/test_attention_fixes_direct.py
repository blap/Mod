"""
Simple test for attention mechanism fixes without going through __init__.py
"""
import torch
import sys
import os
...
def test_rotary_embeddings_with_position_ids():
    ...
    from src.qwen3_vl.attention.flash_attention_2 import apply_rotary_pos_emb, Qwen3VLRotaryEmbedding
