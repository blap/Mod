...
# Import the plugin creation functions with error handling
def safe_import(module_path, func_name):
    try:
        module = __import__(module_path, fromlist=[func_name])
        return getattr(module, func_name)
    except Exception as e:
        print(f"Could not import {func_name} from {module_path}: {e}")
        return None

create_glm_4_7_flash_plugin = safe_import("src.inference_pio.models.glm_4_7_flash.plugin", "create_glm_4_7_flash_plugin")
create_qwen3_4b_instruct_2507_plugin = safe_import("src.inference_pio.models.qwen3_4b_instruct_2507.plugin", "create_qwen3_4b_instruct_2507_plugin")
create_qwen3_coder_30b_plugin = safe_import("src.inference_pio.models.qwen3_coder_30b.plugin", "create_qwen3_coder_30b_plugin")
create_qwen3_vl_2b_instruct_plugin = safe_import("src.inference_pio.models.qwen3_vl_2b.plugin", "create_qwen3_vl_2b_instruct_plugin")
...
def main():
    ...
    if (total_tests + total_benchmarks) > 0:
        success_rate = (passed_tests + passed_benchmarks) / (total_tests + total_benchmarks) * 100
