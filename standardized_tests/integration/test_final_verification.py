...
spec = importlib.util.spec_from_file_location("test_utils", os.path.join(os.path.dirname(__file__), 'src', 'inference_pio', 'test_utils.py'))
...
def test_all_enhanced_functions():
    ...
    assert_tensor_all_close_to_value(torch.tensor([1.0, 1.0001, 1.0002]), 1.0, rtol=1e-2, message="Advanced tensor assertion should work")
    assert_tensor_any_close_to_value(torch.tensor([1.0, 2.0, 3.0]), 1.0001, rtol=1e-2, message="Advanced tensor assertion should work")
    assert_tensor_all_elements_in_range(torch.tensor([1.0, 2.0, 3.0]), 0.0, 4.0, message="Advanced tensor assertion should work")
    assert_tensor_any_elements_in_range(torch.tensor([1.0, 2.0, 3.0]), 2.5, 3.5, message="Advanced tensor assertion should work")
    assert_tensor_all_elements_positive(torch.tensor([1.0, 2.0, 3.0]), message="Advanced tensor assertion should work")
    assert_tensor_any_elements_positive(torch.tensor([-1.0, 0.0, 1.0]), message="Advanced tensor assertion should work")
    assert_tensor_all_elements_finite(torch.tensor([1.0, 2.0, 3.0]), message="Advanced tensor assertion should work")
    assert_tensor_any_elements_finite(torch.tensor([float('inf'), 1.0, 2.0]), message="Advanced tensor assertion should work")
    print("PASS Advanced tensor assertions work")

    # More advanced tensor assertions
    assert_tensor_all_elements_greater_than(torch.tensor([5.0, 6.0, 7.0]), 4.0, message="Advanced tensor assertion should work")
    assert_tensor_any_elements_greater_than(torch.tensor([1.0, 2.0, 3.0]), 2.5, message="Advanced tensor assertion should work")
    assert_tensor_all_elements_less_than(torch.tensor([1.0, 2.0, 3.0]), 4.0, message="Advanced tensor assertion should work")
    assert_tensor_any_elements_less_than(torch.tensor([5.0, 6.0, 7.0]), 6.5, message="Advanced tensor assertion should work")
    assert_tensor_all_elements_between(torch.tensor([2.0, 3.0, 4.0]), 1.0, 5.0, message="Advanced tensor assertion should work")
    assert_tensor_any_elements_between(torch.tensor([1.0, 2.0, 3.0]), 2.5, 3.5, message="Advanced tensor assertion should work")
    assert_tensor_all_elements_unique(torch.tensor([1.0, 2.0, 3.0]), message="Advanced tensor assertion should work")
    assert_tensor_all_elements_sorted(torch.tensor([1.0, 2.0, 3.0]), message="Advanced tensor assertion should work")
    print("PASS More advanced tensor assertions work")
