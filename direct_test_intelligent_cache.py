#!/usr/bin/env python
"""
Direct test of the intelligent cache system without going through model __init__.py
"""
...
# Import the intelligent cache components directly
import torch
from inference_pio.models.qwen3_4b_instruct_2507.intelligent_cache.intelligent_cache_manager import (
