        ...
        if full_path.exists():
            ...
            try:
                ...
                if result['success']:
                    ...
                    print(f"  [FAIL] IMPORT FAILED - Return code: {result['returncode']}")
                    if result['stderr']:
...
'''
    ...
    with open('temp_test_utils_verification.py', 'w', encoding='utf-8') as f:
    ...
    try:
        ...
        print(f"Test utilities verification: {'[PASS]' if util_test_result['success'] else '[FAIL]'}")
...
def main():
    ...
    if overall_success:
        ...
        print(f"\nVERIFICATION PARTIALLY FAILED! Success rate is below 95%.")
