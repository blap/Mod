#!/usr/bin/env python
"""
Accurate test suite to validate all new optimization implementations across all models.
This includes:
...
def test_cross_fusion_and_alignment():
    """Test cross fusion and alignment components across models."""
    
    print("\nTesting Cross Fusion and Alignment Components across models...")
    ...
    try:
        ...
        print("GLM-4.7-Flash: Cross Fusion and Alignment components created successfully")
        
    except ImportError:
        print("GLM-4.7-Flash Cross Fusion and Alignment components not available")
    ...
    try:
        ...
        print("Qwen3-4B-Instruct-2507: Cross Fusion and Alignment components created successfully")
        
    except ImportError:
        print("Qwen3-4B-Instruct-2507 Cross Fusion and Alignment components not available")
    ...
    try:
        ...
        print("Qwen3-Coder-30B: Cross Fusion and Alignment components created successfully")
        
    except ImportError:
        print("Qwen3-Coder-30B Cross Fusion and Alignment components not available")
    ...
    try:
        ...
        print("Qwen3-0.6B: Cross Fusion and Alignment components created successfully")
        
    except ImportError:
        print("Qwen3-0.6B Cross Fusion and Alignment components not available")
    ...
    try:
        ...
        print("Qwen3-Coder-Next: Cross Fusion and Alignment components created successfully")
        
    except ImportError:
        print("Qwen3-Coder-Next Cross Fusion and Alignment components not available")


def test_projection_optimizations():
    """Test projection optimizations across models."""
    
    print("\nTesting Projection Optimizations across models...")
    
    # Test GLM-4.7-Flash
    try:
        from src.models.specialized.glm_4_7_flash.projection_optimizations.projection_optimizations import OptimizedLinearLayer
        
        layer = OptimizedLinearLayer(in_features=512, out_features=256)
        x = torch.randn(10, 512)
        output = layer(x)
        
        print(f"GLM-4.7-Flash: Projection optimization works, output shape: {output.shape}")
        
    except ImportError:
        print("GLM-4.7-Flash Projection optimization not available")
    ...
    try:
        ...
        print(f"Qwen3-4B-Instruct-2507: Projection optimization works, output shape: {output.shape}")
        
    except ImportError:
        print("Qwen3-4B-Instruct-2507 Projection optimization not available")
    
    # Test Qwen3-Coder-30B
    try:
        from src.models.coding.qwen3_coder_30b.projection_optimizations.projection_optimizations import OptimizedLinearLayer
        
        layer = OptimizedLinearLayer(in_features=512, out_features=256)
        x = torch.randn(10, 512)
        output = layer(x)
        
        print(f"Qwen3-Coder-30B: Projection optimization works, output shape: {output.shape}")
        
    except ImportError:
        print("Qwen3-Coder-30B Projection optimization not available")
    
    # Test Qwen3-0.6B
    try:
        from src.models.language.qwen3_0_6b.projection_optimizations.projection_optimizations import OptimizedLinearLayer
        
        layer = OptimizedLinearLayer(in_features=512, out_features=256)
        x = torch.randn(10, 512)
        output = layer(x)
        
        print(f"Qwen3-0.6B: Projection optimization works, output shape: {output.shape}")
        
    except ImportError:
        print("Qwen3-0.6B Projection optimization not available")
    
    # Test Qwen3-Coder-Next
    try:
        from src.models.coding.qwen3_coder_next.projection_optimizations.projection_optimizations import OptimizedLinearLayer
        
        layer = OptimizedLinearLayer(in_features=512, out_features=256)
        x = torch.randn(10, 512)
        output = layer(x)
        
        print(f"Qwen3-Coder-Next: Projection optimization works, output shape: {output.shape}")
        
    except ImportError:
        print("Qwen3-Coder-Next Projection optimization not available")


def test_intelligent_scheduling():
    """Test intelligent scheduling components across models."""
    
    print("\nTesting Intelligent Scheduling Components across models...")
    
    # Test GLM-4.7-Flash
    try:
        from src.inference_pio.models.glm_4_7_flash.scheduling.intelligent_scheduler import IntelligentScheduler
        scheduler = IntelligentScheduler()
        print("GLM-4.7-Flash: Intelligent Scheduler created successfully")
    except ImportError:
        print("GLM-4.7-Flash Intelligent Scheduler not available")
    
    # Test Qwen3-4B-Instruct-2507
    try:
        from src.inference_pio.models.qwen3_4b_instruct_2507.scheduling.intelligent_scheduler import IntelligentScheduler
        scheduler = IntelligentScheduler()
        print("Qwen3-4B-Instruct-2507: Intelligent Scheduler created successfully")
    except ImportError:
        print("Qwen3-4B-Instruct-2507 Intelligent Scheduler not available")
    
    # Test Qwen3-Coder-30B
    try:
        from src.inference_pio.models.qwen3_coder_30b.scheduling.intelligent_scheduler import IntelligentScheduler
        scheduler = IntelligentScheduler()
        print("Qwen3-Coder-30B: Intelligent Scheduler created successfully")
    except ImportError:
        print("Qwen3-Coder-30B Intelligent Scheduler not available")
    
    # Test Qwen3-0.6B
    try:
        from src.inference_pio.models.qwen3_0_6b.scheduling.intelligent_scheduler import IntelligentScheduler
        scheduler = IntelligentScheduler()
        print("Qwen3-0.6B: Intelligent Scheduler created successfully")
    except ImportError:
        print("Qwen3-0.6B Intelligent Scheduler not available")
    
    # Test Qwen3-Coder-Next
    try:
        from src.inference_pio.models.qwen3_coder_next.scheduling.intelligent_scheduler import IntelligentScheduler
        scheduler = IntelligentScheduler()
        print("Qwen3-Coder-Next: Intelligent Scheduler created successfully")
    except ImportError:
        print("Qwen3-Coder-Next Intelligent Scheduler not available")


def test_resource_prediction():
    """Test resource prediction systems across models."""
    
    print("\nTesting Resource Prediction Systems across models...")
    ...
    try:
        ...
        print(f"GLM-4.7-Flash: Resource prediction works, keys: {list(prediction.keys())}")
    except ImportError:
        print("GLM-4.7-Flash Resource Predictor not available")
    ...
    try:
        ...
        predictor = ResourcePredictor()
        prediction = predictor.predict_resources(prompt_length=100, max_new_tokens=50)
        print(f"Qwen3-4B-Instruct-2507: Resource prediction works, keys: {list(prediction.keys())}")
    except ImportError:
        print("Qwen3-4B-Instruct-2507 Resource Predictor not available")
    ...
    try:
        ...
        predictor = ResourcePredictor()
        prediction = predictor.predict_resources(prompt_length=100, max_new_tokens=50)
        print(f"Qwen3-Coder-30B: Resource prediction works, keys: {list(prediction.keys())}")
    except ImportError:
        print("Qwen3-Coder-30B Resource Predictor not available")
    ...
    try:
        ...
        predictor = ResourcePredictor()
        prediction = predictor.predict_resources(prompt_length=100, max_new_tokens=50)
        print(f"Qwen3-0.6B: Resource prediction works, keys: {list(prediction.keys())}")
    except ImportError:
        print("Qwen3-0.6B Resource Predictor not available")
    ...
    try:
        ...
        predictor = ResourcePredictor()
        prediction = predictor.predict_resources(prompt_length=100, max_new_tokens=50)
        print(f"Qwen3-Coder-Next: Resource prediction works, keys: {list(prediction.keys())}")
    except ImportError:
        print("Qwen3-Coder-Next Resource Predictor not available")
...
def main():
    ...
    test_cross_fusion_and_alignment()
    test_projection_optimizations()
