...
def create_qwen3_coder_flash_attention_2(
    config: Qwen3Coder30BConfig, layer_idx: Optional[int] = None
):
    """
...
__all__ = ["Qwen3CoderFlashAttention2", "create_qwen3_coder_flash_attention_2"]
