...
This module implements FlashAttention 2.0 for the GLM-4.7-Flash model using the common implementation.
"""
...
class GLM47FlashAttention2(FlashAttention2):
    """
    GLM-4.7-Flash specific FlashAttention 2.0 implementation using the common base implementation.
    ...
    The implementation is tailored to the specific architecture of the GLM-4.7-Flash model
    with parameters like hidden_size=2048, num_attention_heads=20, etc.
    """
...
def create_glm47_flash_attention_2(
    config: GLM47FlashConfig, layer_idx: Optional[int] = None
):
    """
...
__all__ = ["GLM47FlashAttention2", "create_glm47_flash_attention_2"]
