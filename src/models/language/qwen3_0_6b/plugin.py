...
try:
    ...
    from src.common.interfaces.distributed_execution_interface import DistributedExecutionManagerInterface
    from src.common.interfaces.tensor_compression_interface import TensorCompressionManagerInterface
    from src.common.interfaces.security_interface import SecurityManagerInterface
    from src.common.interfaces.kernel_fusion_interface import KernelFusionManagerInterface
    from src.common.interfaces.adaptive_batching_interface import AdaptiveBatchingManagerInterface
    from src.common.interfaces.model_surgery_interface import ModelSurgeryManagerInterface
    from src.common.interfaces.pipeline_interface import PipelineManagerInterface
    from src.common.interfaces.sharding_interface import ShardingManagerInterface
    from src.common.managers.memory_manager import MemoryManager
    from src.common.managers.distributed_execution_manager import DistributedExecutionManager
    from src.common.managers.tensor_compression_manager import TensorCompressionManager
...
class Qwen3_0_6B_Plugin(
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            compatibility={"torch_version": ">=2.0.0", "min_memory_gb": 1.5},
    ...
    def force_memory_cleanup(self) -> bool:
        ...
        return self._memory_manager.force_memory_cleanup()
    ...
    def start_predictive_memory_management(self, **kwargs) -> bool:
        ...
        return self._memory_manager.start_predictive_memory_management(**kwargs)

    def stop_predictive_memory_management(self) -> bool:
        """Stop predictive memory management."""
        return self._memory_manager.stop_predictive_memory_management()
    ...
    def apply_kernel_fusion(self, model: torch.nn.Module = None) -> bool:
        ...
        try:
            ...
            if model is None:
                ...
                # Also update the model wrapper if it exists
                if hasattr(self, "_model_wrapper") and self._model_wrapper is not None:
                    self._model_wrapper._model = fused_model
    ...
    def perform_model_surgery(
        ...
        try:
            ...
            if model is None:
                ...
                if hasattr(self, "_model_wrapper") and self._model_wrapper is not None:
                    self._model_wrapper._model = modified_model
