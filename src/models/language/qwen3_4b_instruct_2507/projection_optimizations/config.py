"""
Configuration for Qwen3-4B-Instruct-2507 Projection Optimizations

This module defines the configuration settings for Qwen3-4B-Instruct-2507 projection optimizations.
"""
...
@dataclass
class Qwen3_4BInstructProjectionConfig:
    """
    Configuration for Qwen3-4B-Instruct-2507 projection optimizations.
    """
...
DEFAULT_QWEN3_4B_INSTRUCT_PROJECTION_CONFIG = Qwen3_4BInstructProjectionConfig()
...
def get_qwen3_4b_instruct_projection_config(**kwargs) -> Qwen3_4BInstructProjectionConfig:
    """
    Get Qwen3-4B-Instruct-2507 projection configuration with optional overrides.
    
    Args:
        **kwargs: Configuration overrides
        
    Returns:
        Qwen3_4BInstructProjectionConfig: Configuration object
    """
    config = DEFAULT_QWEN3_4B_INSTRUCT_PROJECTION_CONFIG
