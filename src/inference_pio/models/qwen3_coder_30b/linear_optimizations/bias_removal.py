"""
Qwen3-Coder-30B Linear Layer Bias Optimization Implementation

This module implements bias removal optimization for linear layers in the Qwen3-Coder-30B model.
"""
...
def apply_bias_removal_to_model(model: nn.Module, config: Optional[BiasRemovalConfig] = None, model_type: str = "qwen3_coder") -> Tuple[nn.Module, Dict]:
    """
...
def apply_bias_removal_during_model_loading(model: nn.Module, config: Qwen3Coder30BConfig) -> nn.Module:
    """
    Apply bias removal optimization during model loading based on Qwen3-Coder-30B specific configuration.
