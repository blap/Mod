...
def create_qwen3_coder_kernel_manager(config: Qwen3Coder30BConfig) -> Qwen3CoderHardwareKernelManager:
    """
...
def apply_qwen3_coder_optimizations_to_model(model: nn.Module, config: Qwen3Coder30BConfig) -> nn.Module:
    """
...
def get_qwen3_coder_optimization_report(model: nn.Module, config: Qwen3Coder30BConfig) -> Dict:
    """
