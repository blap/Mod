...
and modified versions of the Qwen3-Coder-30B model.
"""
...
class Qwen3Coder30BInferenceSpeedComparisonBenchmark:
    ...
    def load_original_model(self):
        ...
        success = plugin.initialize(device="cpu", model_path="H:/Qwen3-Coder-30B")
        if not success:
    ...
    def run_comparison_benchmark(self):
        ...
        print("="*70)
        print("QWEN3-CODER-30B INFERENCE SPEED COMPARISON BENCHMARK")
        print("="*70)
        ...
        # Print summary
        print("\n" + "="*70)
        print("SUMMARY - QWEN3-CODER-30B INFERENCE SPEED COMPARISON")
        print("="*70)
        print(f"{'Input Length':<12} {'Orig TPS':<12} {'Mod TPS':<12} {'Improvement %':<15}")
        print("-"*50)
    ...
    def save_results(self):
        ...
        json_filename = os.path.join(
            self.results_dir, 
            f"qwen3_coder_30b_inference_speed_comparison_{timestamp}.json"
        )
        ...
        csv_filename = os.path.join(
            self.results_dir, 
            f"qwen3_coder_30b_inference_speed_comparison_{timestamp}.csv"
        )
