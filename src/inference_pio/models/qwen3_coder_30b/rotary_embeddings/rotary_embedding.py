"""
Qwen3-Coder-30B Rotary Embedding Implementation

This module implements optimized rotary embeddings for the Qwen3-Coder-30B model.
"""
...
class Qwen3CoderRotaryEmbedding(nn.Module):
    """
    Qwen3-Coder-30B specific Rotary Embedding implementation.

    This implementation is optimized for the Qwen3-Coder-30B model's architecture
    ...
    def __init__(
        self,
        dim: int,
        max_position_embeddings: int = 32768,  # Qwen3-Coder specific
        base: float = 1000000.0,  # Qwen3-Coder specific base
        precision: torch.dtype = torch.float16,
        device: Optional[str] = None,
    ):
        """
        Initialize Qwen3-Coder-30B Rotary Embedding.

        Args:
            dim: Dimension of the embeddings
            max_position_embeddings: Maximum sequence length (Qwen3-Coder specific)
            base: Base value for computing frequencies (Qwen3-Coder specific)
        ...
        self._set_cos_sin_cache(seq_len=max_position_embeddings, device=device or "cpu", dtype=precision)
