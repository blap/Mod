...
class Qwen3Coder30BConfigurablePlugin(ConfigurableModelPlugin):
    ...
    def initialize(self, **kwargs) -> bool:
        ...
        try:
            ...
            model_id = self.metadata.name if hasattr(self, 'metadata') else 'qwen3_coder_30b'
    ...
    def load_model(self, config: Any = None) -> nn.Module:
        ...
        try:
            ...
            logger.info(f"Qwen3-Coder-30B model loaded with configuration: {config.model_name}")
            return self._model
        except Exception as e:
