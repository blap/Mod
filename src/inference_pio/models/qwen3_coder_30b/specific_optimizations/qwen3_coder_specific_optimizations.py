...
class Qwen3CoderOptimizationConfig:
    ...
    code_rotary_embedding_base: float = (
        1000000.0  # Higher base for longer code contexts
    )


def apply_qwen3_coder_specific_optimizations(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_syntax_aware_attention(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_code_specific_ffn_optimizations(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_code_memory_efficient_kv(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_code_layer_norm_fusion(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_code_residual_connection_optimization(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_multilang_processing_optimizations(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
...
def _apply_code_rotary_embeddings(
    model: nn.Module, config: Qwen3CoderOptimizationConfig
) -> nn.Module:
    """
