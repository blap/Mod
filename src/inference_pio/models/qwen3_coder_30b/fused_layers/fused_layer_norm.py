"""
Qwen3-Coder-30B Fused Layer Normalization Implementation

This module implements fused layer normalization for the Qwen3-Coder-30B model.
"""
...
class FusedLayerNorm(nn.Module):
    """
    Fused Layer Normalization implementation for Qwen3-Coder-30B model.
...
class FusedRMSNorm(nn.Module):
    """
    Fused Root Mean Square Normalization implementation for Qwen3-Coder-30B model.
...
def replace_layer_norm_in_model(model: nn.Module, config: Qwen3Coder30BConfig) -> nn.Module:
    """
...
def replace_rms_norm_in_model(model: nn.Module, config: Qwen3Coder30BConfig) -> nn.Module:
    """
