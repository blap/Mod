...
class Qwen3VL2BMultimodalFusionLayer(BaseMultimodalFusionLayer):
    ...
    def __init__(
        ...
        alignment_method = getattr(config, 'cross_modal_alignment_method', 'qwen3_vl_specific')
...
class Qwen3VL2BAdaptiveMultimodalAttention(BaseAdaptiveMultimodalAttention):
    ...
    def __init__(
        ...
        adaptive_strategy = getattr(config, 'adaptive_attention_strategy', 'input_dependent')
...
def create_qwen3_vl_multimodal_attention(config: Qwen3VL2BConfig, layer_idx: Optional[int] = None):
    """
...
def create_qwen3_vl_modality_specific_attention(config: Qwen3VL2BConfig, modality: str, layer_idx: Optional[int] = None):
    """
...
def create_qwen3_vl_multimodal_fusion_layer(config: Qwen3VL2BConfig, layer_idx: Optional[int] = None):
    """
...
def create_qwen3_vl_adaptive_multimodal_attention(config: Qwen3VL2BConfig, layer_idx: Optional[int] = None):
    """
