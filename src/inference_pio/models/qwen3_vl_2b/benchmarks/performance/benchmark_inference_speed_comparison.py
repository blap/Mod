...
and modified versions of the Qwen3-VL-2B model.
"""
...
class Qwen3VL2BInferenceSpeedComparisonBenchmark:
    ...
    def load_original_model(self):
        ...
        success = plugin.initialize(device="cpu", model_path="H:/Qwen3-VL-2B-Instruct")
        if not success:
    ...
    def run_comparison_benchmark(self):
        ...
        print("="*70)
        print("QWEN3-VL-2B INFERENCE SPEED COMPARISON BENCHMARK")
        print("="*70)
        ...
        # Print summary
        print("\n" + "="*70)
        print("SUMMARY - QWEN3-VL-2B INFERENCE SPEED COMPARISON")
        print("="*70)
    ...
    def save_results(self):
        ...
        json_filename = os.path.join(
            self.results_dir, 
            f"qwen3_vl_2b_inference_speed_comparison_{timestamp}.json"
        )
        ...
        csv_filename = os.path.join(
            self.results_dir, 
            f"qwen3_vl_2b_inference_speed_comparison_{timestamp}.csv"
        )
