...
class Qwen3Vl2bBenchmarkDiscovery(BenchmarkDiscovery):
    ...
    def __init__(self):
        ...
        super().__init__(search_paths=[
            "src/inference_pio/models/qwen3_vl_2b/benchmarks"
        ])
...
def run_qwen3_vl_2b_benchmarks(include_categories: List[str] = None) -> Dict[str, Any]:
    ...
    print(f"Discovered {len(discovery.discovered_benchmarks)} Qwen3-vl-2b benchmark functions")
...
def run_qwen3_vl_2b_performance_benchmarks() -> Dict[str, Any]:
    ...
    print(f"Running {len(performance_benchmarks)} Qwen3-vl-2b performance benchmarks...")
