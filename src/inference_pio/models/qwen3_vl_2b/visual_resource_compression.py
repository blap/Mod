"""
Visual Resource Compression System for Qwen3-VL-2B Model - Self-Contained Version
...
class VisualFeatureCompressor(nn.Module):
    ...
    def __init__(self, config: VisualCompressionConfig, model_config: Any):
        super().__init__()
        self.config = config
...
def create_visual_compressor(config: VisualCompressionConfig,
                           model_config: Any) -> VisualFeatureCompressor:
    """
