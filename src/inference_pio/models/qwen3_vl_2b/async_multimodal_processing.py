    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            if not tokenizer or not image_processor:
                ...
                tokenizer = AutoTokenizer.from_pretrained("H:/Qwen3-VL-2B-Instruct", trust_remote_code=True)
                image_processor = AutoImageProcessor.from_pretrained("H:/Qwen3-VL-2B-Instruct", trust_remote_code=True)
            ...
            logger.info("Qwen3-VL-2B asynchronous multimodal manager initialized successfully")
            return True

        except Exception as e:
            logger.error(f"Failed to initialize Qwen3-VL-2B asynchronous multimodal manager: {e}")
            return False
...
class AsyncMultimodalProcessor:
    ...
    def __init__(self,
        ...
        logger.info(f"Initialized AsyncMultimodalProcessor with max_concurrent={max_concurrent_requests}, "
