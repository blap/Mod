"""
Test Discovery for Qwen3 VL 2B Model

This module provides test discovery for the Qwen3 VL 2B model tests.
"""

import sys
import os

# Calculate the project root directory (the GitHub/Mod directory)
current_dir = os.path.dirname(__file__)
src_dir = os.path.abspath(os.path.join(current_dir, '..', '..', '..', '..'))  # This gets us to the src directory
...
def discover_tests():
    """
    Discover all tests for the Qwen3 VL 2B model.
...
def run_tests(verbose=True):
    """
    Run all discovered tests for the Qwen3 VL 2B model.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run tests for Qwen3 VL 2B model')
