...
def test_vision_encoder_optimization_config():
    ...
    print(f"Default patch embedding optimization: {default_config.enable_patch_embedding_optimization}")
    print(f"Default attention optimization: {default_config.enable_attention_optimization}")
    ...
    print(f"Custom patch embedding optimization: {custom_config.enable_patch_embedding_optimization}")
