...
# Replace transformers dependency with custom config
try:
    from ....common.config.generation_config import CustomGenerationConfig as GenerationConfig
except ImportError:
    # Fallback if common path is not accessible yet (e.g., during refactor)
    # Define minimal config locally
