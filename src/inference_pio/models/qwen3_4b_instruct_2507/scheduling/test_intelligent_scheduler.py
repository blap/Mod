"""
Test suite for Intelligent Scheduling System for Qwen3-4B-Instruct-2507 Model.
"""
...
from src.inference_pio.models.qwen3_4b_instruct_2507.scheduling.intelligent_scheduler import (
...
class TestIntelligentScheduler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = IntelligentSchedulerConfig(
            ...
            priority_decay_factor=0.92,
            enable_load_balancing=True,
            load_balance_interval=0.08,
...
class TestIntelligentSchedulerIntegration(unittest.TestCase):
    ...
    def test_create_scheduler_for_qwen3_4b(self):
        """Test creating an intelligent scheduler specifically for Qwen3-4B-Instruct-2507."""
        mock_config = MagicMock()
        mock_config.intelligent_scheduling_max_concurrent_ops = 32
        mock_config.intelligent_scheduling_policy = 'intelligent'
        mock_config.intelligent_scheduling_enable_prediction = True
        mock_config.intelligent_scheduling_prediction_horizon = 15
        mock_config.intelligent_scheduling_enable_adaptive = True
        mock_config.intelligent_scheduling_adaptive_window = 150
        mock_config.intelligent_scheduling_enable_resource_opt = True
        mock_config.intelligent_scheduling_resource_buffer = 0.15
        mock_config.intelligent_scheduling_enable_priority_boost = True
        mock_config.intelligent_scheduling_priority_decay = 0.92
        mock_config.intelligent_scheduling_enable_load_balancing = True
        mock_config.intelligent_scheduling_load_balance_interval = 0.08
        mock_config.intelligent_scheduling_performance_log_interval = 75

        scheduler = create_intelligent_scheduler_for_qwen3_4b(mock_config)
        
        self.assertIsInstance(scheduler, IntelligentOperationScheduler)
        self.assertEqual(scheduler.config.max_concurrent_ops, 32)
        ...
        self.assertEqual(scheduler.config.prediction_horizon, 15)
