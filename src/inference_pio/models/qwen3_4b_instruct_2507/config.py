...
@dataclass
class Qwen34BInstruct2507Config:
    """
    ...
    model_path: str = "H:/Qwen3-4B-Instruct-2507"  # Local model path on drive H
    ...
    num_key_value_heads: int = 32  # Should match num_attention_heads for standard attention
    ...
    use_qwen3_attention_optimizations: bool = True  # Enable Qwen3-specific attention optimizations
    use_qwen3_kv_cache_optimizations: bool = True  # Enable Qwen3-specific KV-cache optimizations
    use_qwen3_instruction_optimizations: bool = True  # Enable Qwen3-specific instruction tuning optimizations
    use_qwen3_rope_optimizations: bool = True  # Enable Qwen3-specific RoPE optimizations
    use_qwen3_gqa_optimizations: bool = True  # Enable Qwen3-specific GQA optimizations
    qwen3_attention_sparsity_ratio: float = 0.3  # Sparsity ratio for Qwen3 attention optimizations
    qwen3_kv_cache_compression_ratio: float = 0.6  # Compression ratio for Qwen3 KV-cache optimizations
    qwen3_instruction_attention_scaling: float = 1.2  # Scaling factor for instruction-related attention
    qwen3_extended_context_optimization: bool = True  # Enable optimizations for extended context lengths
    qwen3_speculative_decoding_enabled: bool = False  # Enable speculative decoding for faster inference
    qwen3_speculative_draft_model_ratio: float = 0.5  # Ratio of draft model size to main model
    qwen3_speculative_max_tokens: int = 5  # Max speculative tokens to generate
    qwen3_instruction_prompt_enhancement: bool = True  # Enable prompt enhancement for instruction tasks
    qwen3_response_quality_optimization: bool = True  # Enable optimizations for response quality
    qwen3_memory_efficient_inference: bool = True  # Enable memory-efficient inference optimizations
    qwen3_compute_efficient_inference: bool = True  # Enable compute-efficient inference optimizations
