...
class Qwen34BFlashAttention2(FlashAttention2):
    ...
    def __init__(
        self, config: Qwen34BInstruct2507Config, layer_idx: Optional[int] = None
    ):
...
def create_qwen3_4b_flash_attention_2(
...
__all__ = ["Qwen34BFlashAttention2", "create_qwen3_4b_flash_attention_2"]
