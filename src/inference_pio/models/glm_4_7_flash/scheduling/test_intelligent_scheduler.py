"""
Test suite for Intelligent Scheduling System for GLM-4.7-Flash Model.
"""
...
from src.inference_pio.models.glm_4_7_flash.scheduling.intelligent_scheduler import (
...
class TestIntelligentSchedulerIntegration(unittest.TestCase):
    ...
    def test_create_scheduler_for_glm47(self):
        """Test creating an intelligent scheduler specifically for GLM-4.7-Flash."""
        mock_config = MagicMock()
        mock_config.intelligent_scheduling_max_concurrent_ops = 16
        mock_config.intelligent_scheduling_policy = 'intelligent'
        mock_config.intelligent_scheduling_enable_prediction = True
        mock_config.intelligent_scheduling_prediction_horizon = 10
        mock_config.intelligent_scheduling_enable_adaptive = True
        mock_config.intelligent_scheduling_adaptive_window = 100
        mock_config.intelligent_scheduling_enable_resource_opt = True
        mock_config.intelligent_scheduling_resource_buffer = 0.1
        ...
        mock_config.intelligent_scheduling_load_balance_interval = 0.1
        mock_config.intelligent_scheduling_performance_log_interval = 50

        scheduler = create_intelligent_scheduler_for_glm47(mock_config)
        
        self.assertIsInstance(scheduler, IntelligentOperationScheduler)
        self.assertEqual(scheduler.config.max_concurrent_ops, 16)
        ...
        self.assertEqual(scheduler.config.prediction_horizon, 10)
