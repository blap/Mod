...
class GLM47FlashConfig:
    ...
    model_path: str = "H:/GLM-4.7-Flash"  # Default local model path on drive H - should be overridden in production
    ...
    max_position_embeddings: int = 202752  # Extended for GLM-4.7-Flash (from real config)
    ...
    use_cache: bool = True
    torch_dtype: str = "bfloat16"  # Use bfloat16 as per real model config
    ...
    eos_token_id: List[int] = None  # Will be set to [154820, 154827, 154829] from real config
    ...
    use_glm_attention_patterns: bool = True  # Enable GLM-4.7-Flash specific attention patterns
    glm_attention_pattern_sparsity: float = 0.3  # Sparsity ratio for GLM-4.7-Flash attention patterns
    glm_attention_window_size: int = 1024  # Window size for GLM-4.7-Flash attention patterns
    use_glm_ffn_optimization: bool = True  # Enable GLM-4.7-Flash specific FFN optimization
    ...
    use_glm_memory_efficient_kv: bool = True  # Enable GLM-4.7-Flash specific memory-efficient KV-cache
    glm_kv_cache_compression_ratio: float = 0.5  # Compression ratio for GLM-4.7-Flash KV-cache
    use_glm_layer_norm_fusion: bool = True  # Enable GLM-4.7-Flash specific LayerNorm fusion
    use_glm_residual_connection_optimization: bool = True  # Enable GLM-4.7-Flash specific residual connection optimization
    ...
    def __post_init__(self):
        ...
        if self.eos_token_id is None:
            self.eos_token_id = [154820, 154827, 154829]  # From real GLM-4.7-Flash config
