...
def _apply_glm_attention_patterns(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
...
def _apply_glm_ffn_optimizations(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
...
def _apply_glm_memory_efficient_kv(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
...
def _apply_glm_layer_norm_fusion(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
...
def _apply_glm_residual_connection_optimization(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
...
def _apply_glm_quantization(model: nn.Module, config: GLM47OptimizationConfig) -> nn.Module:
    """
