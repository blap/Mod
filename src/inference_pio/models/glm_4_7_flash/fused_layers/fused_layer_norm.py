...
def replace_layer_norm_in_model(model: nn.Module, config: GLM47Config) -> nn.Module:
    """
...
def replace_rms_norm_in_model(model: nn.Module, config: GLM47Config) -> nn.Module:
    """
