...
def register_glm4_moe_lite_architecture():
    ...
    try:
        ...
        class Glm4MoeLiteForCausalLM(
            PreTrainedModel
        ):  # Usando PreTrainedModel como base
        ...
        if hasattr(modeling_auto, "MODEL_FOR_CAUSAL_LM_MAPPING_NAMES"):
            modeling_auto.MODEL_FOR_CAUSAL_LM_MAPPING_NAMES["glm4_moe_lite"] = (
...
def ensure_glm47_flash_support():
    ...
    try:
        ...
        return (
            register_glm4_moe_lite_architecture()
        )  # Tenta registrar de qualquer forma
