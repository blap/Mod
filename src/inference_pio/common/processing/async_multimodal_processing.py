...
class GenericAsyncMultimodalManager:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(
                "Generic asynchronous multimodal manager initialized successfully"
            )
            return True

        except Exception as e:
            logger.error(
                f"Failed to initialize generic asynchronous multimodal manager: {e}"
            )
            return False
...
class GenericAsyncMultimodalProcessor:
    ...
    def __init__(
        ...
        logger.info(
            f"Initialized GenericAsyncMultimodalProcessor with max_concurrent={max_concurrent_requests}, "
