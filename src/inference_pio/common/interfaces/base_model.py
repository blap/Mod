...
from .improved_base_plugin_interface import ModelPluginInterface
...
class BaseModel(nn.Module):
    ...
    def get_input_embeddings(self) -> nn.Module:
        ...
        raise NotImplementedError(
            "get_input_embeddings must be implemented by subclass"
        )
    ...
    def set_input_embeddings(self, value: nn.Module):
        ...
        """
        raise NotImplementedError(
            "set_input_embeddings must be implemented by subclass"
        )
    ...
    def set_output_embeddings(self, new_embeddings: nn.Module):
        ...
        """
        raise NotImplementedError(
            "set_output_embeddings must be implemented by subclass"
        )
    ...
    def resize_token_embeddings(
        ...
        """
        raise NotImplementedError(
            "resize_token_embeddings must be implemented by subclass"
        )
...
class BaseVisionLanguageModel(BaseModel):
    ...
    def generate_text_from_image(
        self, image: Any, prompt: Optional[str] = None, **kwargs
    ) -> str:
        """
        ...
        """
        raise NotImplementedError(
            "generate_text_from_image must be implemented by subclass"
        )
