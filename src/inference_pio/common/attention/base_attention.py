...
class BaseAttention(nn.Module):
    ...
    def _masked_softmax(
        self, attention_scores: torch.Tensor, attention_mask: Optional[torch.Tensor]
    ):
        """
        ...
        return torch.softmax(attention_scores, dim=-1, dtype=torch.float32).to(
...
__all__ = ["BaseAttention", "BaseMultiHeadAttention", "BaseCausalAttention"]
