...
class AccessPatternAnalyzer:
    ...
    def get_access_frequency(self, page_id: str, current_time: float) -> float:
        ...
        with self.lock:
            ...
            recent_accesses = sum(
                1
                for t, pid in self.access_history
...
class TensorPaginationSystem:
    ...
    def __init__(
        ...
        self.swap_directory = (
            Path(swap_directory) if swap_directory else Path("./tensor_swap")
        )
        ...
        logger.info(
            f"Initialized TensorPaginationSystem with swap_directory={self.swap_directory}, "
