    ...
    def _array_to_param_dict(self, param_array: np.ndarray) -> Dict[str, Any]:
        ...
        for i, hp in enumerate(self.hyperparameters):
            ...
            if hp.type == 'int':
                ...
                param_dict[hp.name] = hp.choices[idx] if hp.choices else hp.default_value
        return param_dict
...
class PerformanceHyperparameterOptimizer:
    ...
    def optimize_for_model(
        ...
        return self.optimizer.optimize(
            ...
            n_calls=n_calls,
            minimize=(target_metric in ["latency", "memory"]),  # Minimize for latency/memory
    ...
    def _apply_params_to_model(self, model: nn.Module, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _restore_params_from_model(self, model: nn.Module, original_values: Dict[str, Any]):
