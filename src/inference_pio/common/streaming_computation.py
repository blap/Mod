...
class StreamingComputationEngine:
    ...
    def __init__(
        ...
        logger.info(f"Initialized StreamingComputationEngine with max_concurrent={max_concurrent_requests}, "
                ...
                if self.enable_batching:
                    ...
                    with self.batch_lock:
                        ...
                        if len(self.batch_buffer) >= self.max_concurrent_requests:
                            ...
                            timer = threading.Timer(self.batch_timeout, self._process_batch_if_ready)
                            timer.daemon = True
                            timer.start()
                else:
...
class StreamingComputationManager:
    ...
    def submit_request_to_engine(self, engine_name: str, request: StreamRequest) -> Optional[Future]:
