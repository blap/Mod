...
def test_enhanced_benchmark_utils():
    ...
    try:
        ...
        assert (
            calculate_percentage_difference(100, 120) == 20.0
        ), "Percentage difference calculation failed"
        assert (
            calculate_percentage_difference(100, 80) == -20.0
        ), "Negative percentage difference calculation failed"
...
def main():
    ...
    tests = [test_enhanced_benchmark_utils, test_file_existence]
