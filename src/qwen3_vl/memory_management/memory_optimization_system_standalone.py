...
class MemoryConfig:
    ...
    memory_pool_size: int = 2**30  # 1GB default
...
class MemoryDefragmenter:
    ...
    def defragment_memory(self, force: bool = False) -> Dict:
        ...
        original_cache_size = cache.stats['cached_tensors']
        cache.clear_cache()
        final_cache_size = cache.stats['cached_tensors']
        ...
        return {
            ...
            'cached_tensors_cleared': original_cache_size - final_cache_size,
