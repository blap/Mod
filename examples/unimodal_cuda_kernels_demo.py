...
def demonstrate_unimodal_kernels():
    ...
    # LayerNorm kernel
    layernorm_kernel = UnimodalLayerNormKernel(
    ...
    # RMSNorm kernel
    rmsnorm_kernel = UnimodalRMSNormKernel(
        normalized_shape=512,
        eps=1e-5
    )
    ...
    print("   - GLM-4-7: Updated to use optimized attention, MLP, and normalization kernels")
