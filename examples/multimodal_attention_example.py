...
import torch
from inference_pio.models.glm_4_7.model import GLM47Model, GLM47Config
from inference_pio.models.qwen3_4b_instruct_2507.model import Qwen34BInstruct2507Model, Qwen34BInstruct2507Config
...
def demonstrate_multimodal_attention():
    ...
    print(f"   Input shapes: {[inputs[m].shape for m in modalities]}")
    print(f"   Adaptive output shapes: {[adaptive_outputs[m].shape for m in modalities]}")
...
def demonstrate_model_integration():
    ...
    print(f"   Configured with multimodal attention: {glm_config.use_multimodal_attention}")
    ...
    print(f"   Configured with multimodal attention: {qwen4b_config.use_multimodal_attention}")
    ...
    print(f"   Configured with multimodal attention: {qwen_coder_config.use_multimodal_attention}")
    ...
    print(f"   Configured with multimodal attention: {qwen_vl_config.use_multimodal_attention}")
