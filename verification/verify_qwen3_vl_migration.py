...
def check_common_directory_for_qwen3_vl_code():
    ...
    qwen3_vl_keywords = [
        "qwen3.*vl.*2b", "qwen3_vl_2b", "Qwen3VL2B",
        "qwen3vl2b", "qwen3.*vl", "qwen3_vl", "Qwen3VL"
    ]
        ...
        try:
            with open(py_file, 'r', encoding='utf-8', errors='ignore') as f:
                ...
                for keyword in qwen3_vl_keywords:
                    if keyword.replace(".*", "") in content:  # Simple check without regex
...
def check_model_directory_for_qwen3_vl_code():
    ...
    if missing_files:
        ...
        print("[SUCCESS] All expected Qwen3-VL-2B specific files found in model directory")
        return True
...
def verify_imports_work():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("qwen3_vl_2b",
...
def main():
    ...
    if all_checks_passed:
        ...
        print("Qwen3-VL-2B specific code has been successfully migrated to the model plugin directory.")
