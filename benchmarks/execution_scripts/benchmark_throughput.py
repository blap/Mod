"""
Custom Benchmark Executor for Throughput - All Models

This script runs throughput benchmarks for all models without using
...
def run_throughput_benchmark_for_model(model_name: str):
    """
    Run throughput benchmark for a specific model.
    """
    print(f"\n{'='*60}")
    print(f"Running Throughput Benchmark for {model_name}")
    print(f"{'='*60}")
    
    # Import the benchmark module
    module_path = f"inference_pio.models.{model_name}.benchmarks.performance.benchmark_throughput"
    try:
    ...
    test_methods = [
        'test_requests_per_second_sequential',
        'test_requests_per_second_concurrent',
...
def run_all_throughput_benchmarks():
    """
    Run throughput benchmarks for all models.
    """
    models = [
        "glm_4_7",
    ...
    print("Starting Throughput Benchmarks for All Models...")
    
    all_results = {}
    for model in models:
        result = run_throughput_benchmark_for_model(model)
...
if __name__ == "__main__":
    results = run_all_throughput_benchmarks()
