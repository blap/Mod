"""
Custom Benchmark Executor for Model Comparison - All Models

This script runs model comparison benchmarks for all models without using
...
def run_comparison_benchmark_for_model(model_name: str):
    """
    Run comparison benchmark for a specific model.
    """
    print(f"\n{'='*60}")
    print(f"Running Model Comparison Benchmark for {model_name}")
    print(f"{'='*60}")
    
    # Import the benchmark module
    module_path = f"inference_pio.models.{model_name}.benchmarks.integration.benchmark_comparison"
    try:
    ...
    test_methods = [
        'test_model_comparison_inference_speed',
        'test_model_comparison_memory_usage',
        'test_model_comparison_accuracy',
        'test_model_comparison_throughput'
    ]
...
def run_all_comparison_benchmarks():
    """
    Run comparison benchmarks for all models.
    """
    models = [
        "glm_4_7",
    ...
    print("Starting Model Comparison Benchmarks for All Models...")
    
    all_results = {}
    for model in models:
        result = run_comparison_benchmark_for_model(model)
...
if __name__ == "__main__":
    results = run_all_comparison_benchmarks()
    ...
    print(f"\nResults saved to comparison_benchmark_results.json")