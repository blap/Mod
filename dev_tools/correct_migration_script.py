...
def migrate_remaining_qwen3_vl_specific_code():
    ...
    model_dir = Path("C:/Users/Admin/Documents/Mod/src/inference_pio/models/qwen3_vl_2b")
...
def update_common_init():
    ...
    if common_init_path.exists():
        ...
        for line in lines:
            ...
            if not any(alias in line for alias in [
                "Qwen3VL2BConfig",
...
__all__ = [
    ...
    for filename, content in generic_modules.items():
        file_path = Path(f"C:/Users/Admin/Documents/GitHub/Mod/src/inference_pio/common/{filename}")
