...
def migrate_qwen3_vl_specific_code():
    ...
    model_dir = Path("C:/Users/Admin/Documents/GitHub/Mod/src/inference_pio/models/qwen3_vl_2b")
    ...
    for file_name in qwen3_vl_specific_files:
        ...
        if src_path.exists():
            ...
            if dst_path.exists():
                print(f"  Warning: {dst_path} already exists, skipping migration for this file")
                continue
            ...
            print(f"  Warning: {src_path} does not exist, checking for alternative names...")
            ...
            if not moved:
                print(f"  Could not find {file_name} or alternatives in common directory")
    ...
    for subdir_name in subdirs_to_check:
        ...
        if src_subdir.exists():
            ...
            if dst_subdir.exists():
                print(f"  Warning: {dst_subdir} already exists, removing and replacing...")
...
def update_imports_and_references():
    ...
    common_init_path = Path("C:/Users/Admin/Documents/GitHub/Mod/src/inference_pio/common/__init__.py")
    ...
    if common_init_path.exists():
        ...
        for line in lines:
            ...
            if any(keyword in line for keyword in [
                'Qwen3VL2B', 'qwen3_vl', 'Qwen3-VL', 'qwen3vl'
            ]):
        ...
        if '__all__' in new_content:
            ...
            new_all_section = '\n'.join(all_items)
            new_content = new_content[:all_start] + new_all_section + new_content[all_end:]
